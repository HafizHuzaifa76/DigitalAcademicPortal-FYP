...
import 'package:digital_academic_portal/features/admin/shared/noticeboard/domain/entities/MainNotice.dart';
                    ...
                    return Padding(
                      ...
                      child: Card(
                        ...
                        child: ListTile(
                          title: Row(
                            children: [
                              Text(notice.title, style: TextStyle(fontWeight: FontWeight.bold, color: Get.theme.primaryColor, fontFamily: 'Ubuntu', fontSize: 21)),

                              const Spacer(),
                              IconButton(
                                onPressed: () =>
                                    editNoticeBottomSheet(context, notice),
