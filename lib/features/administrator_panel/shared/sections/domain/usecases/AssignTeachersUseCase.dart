...
class AssignTeachersUseCase implements UseCase<void, AssignTeachersParams> {
  ...
  Future<Either<Fail, void>> execute(AssignTeachersParams params) async {
    return await repository.assignTeacherToCourses(params.deptName,
        params.semester, params.section, params.coursesTeachersMap);
  }
}

class EditAssignTeachersUseCase
    implements UseCase<void, EditAssignTeachersParams> {
  final SectionRepository repository;
  ...
  Future<Either<Fail, void>> execute(EditAssignTeachersParams params) async {
    return await repository.editAssignedTeachers(params.deptName,
        params.semester, params.section, params.courseName, params.teacher);
  }
}

class FetchAssignedTeachersUseCase
  ...
  Future<Either<Fail, Map<String, String?>>> execute(
    ...
    return await repository.fetchAssignedTeachers(
        params.deptName, params.semester, params.section);
  }
}
