...
class DepartmentNoticeBoardPage extends StatefulWidget {
  final String department;
  const DepartmentNoticeBoardPage({super.key, required this.department});

  @override
  State<DepartmentNoticeBoardPage> createState() =>
      _DepartmentNoticeBoardPageState();
}

class _DepartmentNoticeBoardPageState extends State<DepartmentNoticeBoardPage> {
  ...
  void initState() {
    ...
    try {
      ...
      controller?.showAllDepartmentNotices(widget.department);
      ;
    } catch (e) {
                ...
                Container(
                  ...
                  child: IconButton(
                    onPressed: () => controller!
                        .deleteDepartmentNotice(widget.department, notice),
                    icon: const Icon(
                      Icons.delete,
                      color: Colors.red,
                      size: 20,
        ...
        return Container(
          ...
          child: buildNoticeForm(context, addNoticeKey, "Add", () {
            if (addNoticeKey.currentState!.validate()) {
              controller!.addDepartmentNotice(widget.department);
              Get.back();
            }
          }),
        );
        ...
        return Container(
          ...
          child: buildNoticeForm(context, editNoticeKey, "Edit", () {
            if (editNoticeKey.currentState!.validate()) {
              controller!.editDepartmentNotice(widget.department, notice);
              Get.back();
            }
          }),
        );
