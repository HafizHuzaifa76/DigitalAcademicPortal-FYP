import 'package:digital_academic_portal/features/teacher_panel/shared/teacher_calendar_events/presentation/controllers/TeacherCalendarEventController.dart';
...
class TeacherCalendarPage extends StatefulWidget {
  ...
  @override
  State<TeacherCalendarPage> createState() => _TeacherCalendarPage();
}

class _TeacherCalendarPage extends State<TeacherCalendarPage> {
  final TeacherCalendarEventController _controller = Get.find();
