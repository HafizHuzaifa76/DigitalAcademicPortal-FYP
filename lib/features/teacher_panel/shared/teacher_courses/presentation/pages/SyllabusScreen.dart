...
class SyllabusScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.getFiles(course, domain.FileType.syllabus);
    });
    ...
    return Scaffold(
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Upload course syllabus for ${course.courseName}',
                    style: TextStyle(
      ...
      floatingActionButton: Obx(() {
        ...
        return FloatingActionButton(
          ...
          onPressed: () =>
              controller.uploadFile(course, domain.FileType.syllabus),
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              controller.deleteFile(file.id, course, domain.FileType.syllabus);
            },
