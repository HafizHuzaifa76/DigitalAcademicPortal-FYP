...
class LectureSlidesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      controller.getFiles(course, domain.FileType.lectureSlide);
    });
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          '${course.courseCode} Lecture Slides',
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Upload lecture slides for ${course.courseName}',
                    style: TextStyle(
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Click the upload button to add lecture slides',
                        style: TextStyle(
                          fontSize: 14,
      ...
      floatingActionButton: Obx(() {
        ...
        return FloatingActionButton(
          ...
          onPressed: () =>
              controller.uploadFile(course, domain.FileType.lectureSlide),
      ...
      builder: (context) => AlertDialog(
        ...
        title: Row(
          children: [
            ...
            const SizedBox(width: 12),
            const Text('Delete Lecture Slide',
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              controller.deleteFile(
                  file.id, course, domain.FileType.lectureSlide);
            },
